...
class GreedyDecoder(torch.nn.Module):
    ...
    def forward_pass(
        ...
        decoder_input_vector = torch.ones(1, 1, device=device, dtype=torch.long) * vocabulary.START
        ...
        for _ in range(max_length):
            ...
            decoder_softmax_scores, decoder_input_vector = torch.max(decoder_output, dim=1)
